(function() {
   ...
   var html = '<div id="otg-org-top-bar" style="position: relative; width: 100%; background-color: #005284; z-index: 2000000; box-shadow: 0 4px 5px 0px grey; top: 0; height: 50px;">';
    html += '<img src="/logo.png" title="Logo" alt="' + organisationName + '" style="float: left; margin-left: 20px; margin-top: 5px; height: 40px;" class="org_logo" />';
    html += '<span id="otg-org-username" title="Logged in user" style="float: right; margin-right: 20px; margin-top: 15px; color: white; font-family: Inter, serif; font-style: italic;">&nbsp;</span>';
    html += '</div>';
